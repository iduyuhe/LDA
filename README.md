...
- 诚实边界：当前属**原理验证级非流片级**；实证语料 29 条中 **24 条 A 级可公开溯源**（含 DOI / 公开 URL 定位符，第三方可独立复验），**5 条 B 级（仅有描述性来源、无定位符）禁止作 golden 进判决**；7 道实证锚题中 **5 道为真·可溯源实测锚**（E1/E2 因无公开可溯源 n_eff 实测源，标为 B 级待溯源、不计入可溯源计数）；真实晶圆厂 NDA 实测仍属发动期。
