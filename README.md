...
> 
> 当前版本：**v0.9.17**（2026-09-02 · **量子侧五道接线 · 严格独立 7 → 12**：延续 P0 接线段，把 B12/B13/B22/B23/B24 五道早宣称有严格侧、harness 从未真接的锚接成真独立候选；严格独立 7→12、自证桩 40→35、降级仍 1（E2）；tol 仅 B13 收紧 50×/B24 按实测重定、余未动；全量回归抓出 B24 候选返回 numpy 标量致 run_harness JSON 序列化 TypeError，已修（candidate 返回值 float 包裹）；⚠️ 诚实边界：独立 12/48、自证桩 35）·
