...
- `run_benchmark_falsifiability_smoke` ⑨ numpy bool 泄漏 JSON（历史遗留，**2026-09-17 后台重跑确认：12 PASS/1 FAIL，FAIL 即 ⑨ `TypeError: Object of type bool is not JSON serializable`，与「已知缺口」逐字一致**）
