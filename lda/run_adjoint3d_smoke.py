"""D-84/85 3D adjoint 形状逆设计 smoke：4 例（shape 正例 + section 正例 + 不同网格 + 非法域负例）。
...
from lda_agent.adjoint3d_design import design_shape3d, design_section3d  # noqa: E402
