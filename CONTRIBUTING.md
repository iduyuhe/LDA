...
当前版本：**v0.9.79** · 账本：**22 引擎（光子 15 + 量子 7）+ 11 包 = 33 类端到端 · 84 道锚（严格独立 63 / 降级 3 / 自证桩 18）· CI core 177 条**。
...
> 当前真值（v0.9.82 / P1-1 B7 golden 语义订正）：**严格独立 63 · 降级 3（E9 + E10 + B21）· 自证桩 18 · 三类和 84**。
