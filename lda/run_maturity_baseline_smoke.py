...
护栏：
  ...
  M5 三分类计数与 README/C2 口径一致（28/1/23，和=53；B2 于 2026-09-10 经 FV-FDM+PWE 双独立全波终审升严格独立；B33 于 2026-09-10 A 档有源扩展 #1 真·新增严格独立锚）。
"""
import os
import sys
...
def main():
    ...
    if (h_strict, h_deg, h_stub) != (31, 1, 23):
        infos.append(f"M5 三分类口径=({h_strict},{h_deg},{h_stub})（期望 (31,1,23)）")
