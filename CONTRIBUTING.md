...
当前版本：**v0.9.97** · 账本：**22 引擎（光子 15 + 量子 7）+ 11 包 = 33 类端到端 · 314 道锚（严格独立 293 / 降级 3 / 自证桩 18）· CI core 178 条**。
...
cd lda
python run_ci_regression.py --tag core      # CI core 全量（178 条 smoke）
...
> 当前真值（v0.9.97 / P1-1 B-17 扩基）：**严格独立 293 · 降级 3（E9 + E10 + B21）· 自证桩 18 · 三类和 314**。
