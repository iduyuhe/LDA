...
- **22 引擎（光子 15 + 量子 7）+ 11 包 = 33 类端到端**
- **45 题（B1-B27 物理定律锚 + E1-E7 实证锚 + S1-S11 系统锚）**
- **CI core 68 条**（纯 numpy 快速集，FAIL=0 即绿）
