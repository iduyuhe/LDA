...
护栏：
  ...
  M5 三分类计数与 README/C2 口径一致（101/3/18，和=122；B2 于 2026-09-10 经 FV-FDM+PWE 双独立全波终审升严格独立；B33 于 2026-09-10 A 档有源扩展 #1 真·新增严格独立锚；B-4 于 2026-09-16 扩基 22 道严格独立锚达 85；B-5 于 2026-09-16 扩基 16 道严格独立锚达 101）。
"""
import os
import sys
