# LDA 设计商店 · 市场与行业趋势分析（v0.8.47 扩货架依据）
...
| 方向 | 代表货架 | 市场信号 |
|---|---|---|
| 高速收发 | 800G DR8 / PSM4 / FR4 / CWDM4 / LPO-112G | 800G 规模放量、1.6T 渗透、LPO 去 DSP 降功耗成重要路径 |
| WDM 解复用 | 8CH / 40CH DWDM | 数据中心波分复用、C 波段 ITU 网格需求 |
| CPO / OCS | CPO-WDM5 / CPO-OCS | NVIDIA/谷歌押注，2026 量产拐点 |
| 接入网 | FTTH PLC 1×8 / 1×16 | PON 无源分光，量大面广 |
| 传感 | 微环 RING / MZI / FMCW LIDAR | 生物化学折射率感测、激光雷达细分 |
| 先进封装 | 光 Chiplet IO | XPU 光 IO、异质集成趋势 |
| 异质集成 | 片上激光集成 LASER-INT | 硅光缺光源，III-V 异质集成热点 |

**开放策略**：上述光子主流方向全量开放（16 个货架），覆盖预研企业最密集的需求面。
