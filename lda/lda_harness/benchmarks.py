...
from ._batch_b19_numeric import (  # noqa: E402  # Batch B-19 双方法独立锚数值核（路径 B 扩基续十七 · 广义 Lane–Emden 奇异 IVP Taylor 启动+RK4/二维 Laplace 间接单层位势 BEM/Eikonal 制造解 FMM · v0.9.99 · 腿① 续加锚稀释 terminal）
    golden_b313, golden_b314, golden_b315, golden_b316, golden_b317,
    golden_b318, golden_b319, golden_b320, golden_b321, golden_b322,
    golden_b323, golden_b324, golden_b325, golden_b326, golden_b327,
    golden_b328,
)

from ._batch_b20_numeric import (  # noqa: E402  # Batch B-20 双方法独立锚数值核（路径 B 扩基续十八 · 修正 Bessel I_nu ODE Frobenius+RK4/球谐 Y_l^m 自投影梯形积分/一维 RBF 插值 · v0.9.100 · 腿① 续加锚稀释 terminal）
    golden_b329, golden_b330, golden_b331, golden_b332, golden_b333,
    golden_b334, golden_b335, golden_b336, golden_b337, golden_b338,
    golden_b339, golden_b340, golden_b341, golden_b342, golden_b343,
    golden_b344,
)

from ._batch_b21_numeric import (  # noqa: E402  # Batch B-21 双方法独立锚数值核（路径 B 扩基续 · Hermite 多项式中心差分 Rodrigues/ Laguerre 多项式中心差分 Rodrigues/ Bernstein 多项式逼近 · v0.9.101 · 腿① 续加锚稀释 terminal）
...
from ._batch_b24_numeric import (  # noqa: E402  # Batch B-24 双方法独立锚数值核（v0.9.106 · 腿① 扩基加锚 · 标量衍射族）
    golden_b387, golden_b388, golden_b389, golden_b390, golden_b391, golden_b392, golden_b393, golden_b394,
    golden_b395, golden_b396, golden_b397, golden_b398, golden_b399,
)

from ._batch_b25_numeric import (  # noqa: E402  # Batch B-25 双方法独立锚数值核（v0.9.107 · 腿① 扩基加锚 · 静电/静磁有限源族）
...
from ._batch_b26_numeric import (  # noqa: E402  # Batch B-26 双方法独立锚数值核（v0.9.108 · 腿① 扩基加锚 · 单界面 Fresnel/Snell 光学族）
...
from ._batch_b27_numeric import (  # noqa: E402  # Batch B-27 双方法独立锚数值核（v0.9.109 · 腿① 扩基加锚 · 色散与群速度族：解析闭式 golden × 中心差分数值微分候选）
...
from ._batch_b28_numeric import (  # noqa: E402  # Batch B-28 双方法独立锚数值核（v0.9.110 · 腿① 扩基加锚 · 不完全 Beta 族 / 积分正余弦函数族：精确特殊函数 golden × 复合 Simpson·RK4 候选）
...
BENCHMARK_DEFS = {
    ...
    # ---- Batch B-25（v0.9.107 · 腿① 扩基加锚 · 静电学 & 静磁学有限源族）----
    "B400": {
    ...
    # ---- Batch B-26（v0.9.108 · 腿① 扩基加锚 · 单界面 Fresnel/Snell 光学族：解析闭式 golden × 1D FD Helmholtz 数值候选）----
    "B413": {
