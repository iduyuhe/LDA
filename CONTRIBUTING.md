...
当前版本：**v0.9.94** · 账本：**22 引擎（光子 15 + 量子 7）+ 11 包 = 33 类端到端 · 266 道锚（严格独立 245 / 降级 3 / 自证桩 18）· CI core 178 条**。
...
> 当前真值（v0.9.94 / P1-1 B-14 扩基）：**严格独立 245 · 降级 3（E9 + E10 + B21）· 自证桩 18 · 三类和 266**。
